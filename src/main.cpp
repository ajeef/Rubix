...
// Copyright (c) 2017 The Rubix developers
...
unsigned int nStakeMinAge       = 1 * 1 * 60;			// 1 Minute
unsigned int nStakeMaxAge       = 1 * 1 * 60 * 60;	// 1 hour
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight > CAP_BLOCK)
    {
        nSubsidy = nCoinAge * COIN_MINEOUT_REWARD / 365;
    }
...
static const int64_t nTargetTimespan = 2 * nTargetSpacing;  // 4 mins
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Rubix", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Android Users Face a new Ransomware Threat - JP Buntinx - January 26, 2017 - THE MERKLE";
        CTransaction txNew;
        txNew.nTime = 1485415205;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1485415205;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 629734 : 10933;
/*
// uncomment to log genesis block info
//      //  start
        if (true && block.GetHash() != hashGenesisBlock) // toggle true to generate when "0x"
                       {
...
*/
        ...
        assert(block.hashMerkleRoot == uint256("0x2e63bb2e16f72f90e7bd142224cad26fef8c25a2cff2d1b11362c76ac91b2362"));
    ...
    string strPubKey = "0131515954ea02c6ee7e03aa790622184349bb52a90cd0a1ce99808e98e64501df7afb3e8fdd8569a2b44e44f1574a6ca3882a9c67554f6bc6f4fbe5e9e2e2dea9";
...
unsigned char pchMessageStart[4] = { 0x11, 0xba, 0x19, 0xa2 };
