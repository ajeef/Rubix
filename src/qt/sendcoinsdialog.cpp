    ...
    fNewRecipientAllowed(true)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a RuBiX address (e.g. iACLambeGgkxodKtfzM7huFXyPYWjz33Z2)"));
#endif
...
void SendCoinsDialog::processSendCoinsReturn(const WalletModel::SendCoinsReturn &sendCoinsReturn, const QString &msgArg)
{
    ...
    case WalletModel::NarrationTooLong:
        ...
        break;
    case WalletModel::rubixFee:
        msgParams.first = tr("A fee %1 times higher than %2 per recipient is considered an rubixly high fee.").arg(10000).arg(BitcoinUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), MIN_RELAY_TX_FEE));
        break;
